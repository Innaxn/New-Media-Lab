...
const TOPICS = [
  ...
  {
    icon: <CookieIcon sx={{ fontSize: 14 }} />,
    label: "Cookies",
    color: "#d94f3d",
  },
  {
    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          height: 520,
          borderRadius: "50%",
          background: `radial-gradient(circle, ${alpha(p.primary, 0.08)} 0%, transparent 70%)`,
          pointerEvents: "none",
        }}
      />
      <Box
        ...
        sx={{
          ...
          height: 420,
          borderRadius: "50%",
          background: `radial-gradient(circle, ${alpha(p.danger, 0.06)} 0%, transparent 70%)`,
          pointerEvents: "none",
        }}
      />
      ...
      >
        ...
        <Button
          ...
          sx={{
            ...
            "&:hover": { boxShadow: `0 8px 32px ${alpha(p.primary, 0.4)}` },
          }}
        >
          ...
          {TOPICS.map((t) => (
            <Chip
              ...
              sx={{
                ...
                fontSize: "0.6875rem",
                fontWeight: 700,
                bgcolor: alpha(t.color, 0.09),
                color: t.color,
                border: `1px solid ${alpha(t.color, 0.22)}`,
                borderRadius: "20px",
